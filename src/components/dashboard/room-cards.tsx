...
export default function RoomCards() {
  return (
    <div className="drop-shadow-md lg:mt-0 lg:w-full lg:flex-shrink-0">
      <div className="bg-white rounded-2xl bg-gray-50 py-8 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-8">
        <div className="mx-10 max-w-xs">
